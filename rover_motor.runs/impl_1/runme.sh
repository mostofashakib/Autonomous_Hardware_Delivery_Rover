...
HD_PWD='C:/Users/19514/Desktop/Project_Lab_1/rover_motor/rover_motor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log movement.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source movement.tcl -notrace
