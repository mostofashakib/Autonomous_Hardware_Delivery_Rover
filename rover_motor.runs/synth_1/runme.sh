...
HD_PWD='C:/Users/19514/Desktop/Project_Lab_1/rover_motor/rover_motor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log movement.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source movement.tcl
