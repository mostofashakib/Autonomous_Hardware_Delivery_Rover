...
set_property PACKAGE_PIN W13 [get_ports {MotorControls[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MotorControls[0]}]
set_property PACKAGE_PIN V2 [get_ports {MotorControls[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MotorControls[1]}]
set_property PACKAGE_PIN T3 [get_ports {MotorControls[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MotorControls[2]}]
set_property PACKAGE_PIN T2 [get_ports {MotorControls[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MotorControls[3]}]
set_property PACKAGE_PIN R3 [get_ports {MotorControls[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MotorControls[4]}]
...
##Sch name = JA9
#set_property PACKAGE_PIN H2 [get_ports {IN4}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {IN4}]
##Sch name = JA10
