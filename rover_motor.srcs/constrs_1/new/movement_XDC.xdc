...
set_property PACKAGE_PIN V17 [get_ports {MotorSpeeds[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MotorSpeeds[0]}]
set_property PACKAGE_PIN V16 [get_ports {MotorSpeeds[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MotorSpeeds[1]}]
set_property PACKAGE_PIN W16 [get_ports {MotorSpeeds[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MotorSpeeds[2]]
set_property PACKAGE_PIN W17 [get_ports {MotorSpeeds[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MotorSpeeds[3]}]
set_property PACKAGE_PIN W15 [get_ports {MotorSpeeds[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MotorSpeeds[4]}]
set_property PACKAGE_PIN V15 [get_ports {MotorSpeeds[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MotorSpeeds[5]}]
set_property PACKAGE_PIN W14 [get_ports {MotorSpeeds[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MotorSpeeds[6]}]
set_property PACKAGE_PIN W13 [get_ports {MotorControls[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MotorControls[7]}]
set_property PACKAGE_PIN V2 [get_ports {MotorControls[8]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MotorControls[8]}]
set_property PACKAGE_PIN T3 [get_ports {MotorControls[9]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MotorControls[9]}]
set_property PACKAGE_PIN T2 [get_ports {MotorControls[10]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MotorControls[10]}]
set_property PACKAGE_PIN R3 [get_ports {MotorControls[11]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MotorControls[11]}]
...
#Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {EnableB}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {EnableB}]
##Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {sendToH_Bridge_INs[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sendToH_Bridge_INs[0]}]
##Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {sendToH_Bridge_INs[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sendToH_Bridge_INs[1]}]
#Sch name = JA5
        set_property PACKAGE_PIN H1 [get_ports {sendToH_Bridge_INs[2]}]     
            set_property IOSTANDARD LVCMOS33 [get_ports {sendToH_Bridge_INs[2]}]
##Sch name = JA6
set_property PACKAGE_PIN K2 [get_ports {sendToH_Bridge_INs[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sendToH_Bridge_INs[3]}]
##Sch name = JA9
